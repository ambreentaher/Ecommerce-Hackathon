    ...
    return(
        <main className="w-full h-full md:h-[500px] flex flex-col md:flex-row justify-between items-start bg-[#F2F0F1]">
            ...
            <div className="relative">
                <Image src={"/hero.png"} className="w-[500px] mr-4" width={200} height={200} alt="Hero"></Image>
                <Image src={"/star.png"} className="w-[50px] md:w-[100px] absolute top-[100px] left-10 md:top-[300px] md:left-[-100px]" width={200} height={200} alt="Hero"></Image>
                <Image src={"/star.png"} className="w-[60px] md:w-[100px] absolute top-10 right-[50px] md:top-[50px] md:right-[30px]" width={200} height={200} alt="Hero"></Image>
            </div>
        </main>
    )
}